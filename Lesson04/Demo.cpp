...
void Demo::Render() {
	...
	// Meja
	DrawColoredCube(1, 2, 3, 1, 2, 3);
	DrawColoredCube(2, 1, 3, 2, 2, 1);
...
void Demo::DrawColoredCube(float s1, float s2, float s3, float sc1, float sc2, float sc3)
{
...
int main(int argc, char** argv) {
	...
	app.Start("Projek Akhir", 800, 600, false, false);
}